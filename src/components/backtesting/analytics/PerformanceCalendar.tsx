...
export default function PerformanceCalendar({ trades, initialBalance }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/[0.01] via-transparent to-purple-500/[0.01] dark:from-cyan-500/[0.02] dark:to-purple-500/[0.02] pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-5">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              <h3 className="text-sm sm:text-base font-semibold text-foreground">Performance Calendar</h3>
