  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-xl font-bold text-white">Trading Accounts</h2>
          <p className="text-gray-500 text-sm mt-1">You can add up to 10 active accounts</p>
        </div>
        <button 
          onClick={() => setAddAcc()}
          className="flex items-center gap-2 px-4 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-white text-sm font-semibold rounded-xl transition-colors"
        >
            ...
            {accounts.length === 0 ? (
              ...
              accounts.map((account, index) => (
                <tr key={index} className="border-b border-[#2a2a2a] hover:bg-[#252525] transition-colors">
                  ...
                  <td className="px-6 py-4 text-center">
                    <button className="w-8 h-8 rounded-lg bg-blue-500/15 hover:bg-blue-500/25 flex items-center justify-center mx-auto transition-colors">
                      <FontAwesomeIcon icon={faSync} className="text-blue-400 text-sm" />
                    </button>
                  </td>
                  <td className="px-6 py-4">
