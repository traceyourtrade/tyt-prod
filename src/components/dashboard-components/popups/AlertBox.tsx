...
const AlertBox = () => {
    ...
    const RenderBox = () => {
        if (alertType === "async-alert" && polling) {
            return (
                <div className={`w-80 h-24 absolute z-10 top-16 right-5 rounded-l-lg border-2 border-gray-700 items-center overflow-hidden text-white bg-gray-900 border-l-4 border-l-blue-600 ${alertType && alertBoxG?"flex":"hidden"}  `}>
                    <FontAwesomeIcon 
                        icon={faXmark} 
            ...
            return (
                <div className={`
                    w-80 h-24 absolute z-10 top-16 right-5 rounded-l-lg border-2 border-gray-700 flex items-center overflow-hidden text-white bg-gray-900 border-l-4
