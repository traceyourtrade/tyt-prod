    ...
    <div className="min-h-screen w-full flex bg-[#050508]">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_80%_50%_at_20%_40%,rgba(56,189,248,0.12),transparent)]" />
        ...
        <motion.div
          ...
          className="absolute top-24 right-24 w-36 h-36 border border-blue-500/10 rounded-full"
        />
        <motion.div
          animate={{ y: [0, -15, 0], x: [0, 8, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-32 left-16 w-14 h-14 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-xl blur-sm"
        />
        <motion.div
          animate={{ y: [0, 12, 0], x: [0, -8, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="absolute top-1/3 right-1/4 w-10 h-10 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-lg blur-sm"
        />
          ...
          >
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-xs text-cyan-400">Welcome back, trader</span>
              </motion.div>
            ...
            <div className="grid grid-cols-2 gap-3 max-w-md">
              {[
                ...
                >
                  <item.icon className="w-4 h-4 text-cyan-400 mb-1.5" />
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-6 sm:p-10">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.99 }}
            className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white text-gray-900 text-sm font-semibold hover:bg-gray-50 transition-all shadow-lg shadow-white/5 mb-6"
          >
          ...
          <form onSubmit={postLoginDetails} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  autoComplete="email"
                  className="w-full pl-10 pr-3 py-2.5 text-sm rounded-lg bg-white/[0.03] border border-white/10 text-white placeholder:text-white/25 outline-none focus:border-cyan-500/50 focus:bg-white/[0.05] focus:ring-1 focus:ring-cyan-500/20 transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 text-sm rounded-lg bg-white/[0.03] border border-white/10 text-white placeholder:text-white/25 outline-none focus:border-cyan-500/50 focus:bg-white/[0.05] focus:ring-1 focus:ring-cyan-500/20 transition-all"
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.01 }}
              whileTap={{ scale: 0.99 }}
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-semibold hover:shadow-lg hover:shadow-cyan-500/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
