      ...
      <div className="p-2 border-t border-border/40">
        {profileData.fullName && (
          <Link 
            ...
            onClick={() => setMobileOpen(false)}
            className={cn(
              "flex items-center gap-2.5 rounded-lg p-2 mb-1 transition-colors duration-150",
              "hover:bg-muted/50",
        ...
        <button
          className={cn(
            "w-full flex items-center gap-3 rounded-lg px-2.5 py-2 text-sm transition-colors duration-150",
