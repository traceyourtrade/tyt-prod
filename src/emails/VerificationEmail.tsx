...
export default function VerificationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Click to verify your email - ProJournX</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Img
              ...
              style={logo}
            />
            <Text style={heading}>Click to verify your email</Text>
            <Text style={description}>
              Welcome to ProJournX. Click the button below to confirm your email
